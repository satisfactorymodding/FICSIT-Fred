...
class CommandCmds(BaseCmds):
    ...
    async def add_command(self, ctx: commands.Context, command_name: str.lower, *, response: str = None):
        ...
        config.Commands(
            name=command_name,
            content=response,
            attachment=attachment and attachment.url,
        )
    ...
    @BaseCmds.slash_search.subcommand(name="search_commands", description="Searches commands for the stuff requested.")
